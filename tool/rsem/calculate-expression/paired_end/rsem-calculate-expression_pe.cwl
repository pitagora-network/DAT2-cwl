...
outputs:
  - id: genes_result
    type: File
    outputBinding:
      glob: $(inputs.rsem_output_prefix.basename).genes.results
  - id: isoforms_result
    type: File
    outputBinding:
      glob: $(inputs.rsem_output_prefix.basename).isoforms.results
  - id: star_output
    type: Directory
    outputBinding:
      glob: $(inputs.rsem_output_prefix.basename).temp
  - id: stat
    type: Directory
    outputBinding:
      glob: $(inputs.rsem_output_prefix.basename).stat
doc: >-
