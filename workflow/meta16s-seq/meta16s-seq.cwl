...
steps:
  ...
  phylogeny.pipelines.align_to_tree_mafft_fasttree:
    run: ../../tool/qiime2/phylogeny.pipelines.align_to_tree_mafft_fasttree/qiime2-phylogeny.pipelines.align_to_tree_mafft_fasttree.cwl
    in:
  ...
  diversity.pipelines.core_metrics_phylogenetic:
    run: ../../tool/qiime2/diversity.pipelines.core_metrics_phylogenetic/qiime2-diversity.pipelines.core_metrics_phylogenetic.cwl
    in:
      table: dada2.methods.denoise_paired/table
  ...
  diversity.visualizers.beta_group_significance.unweighted_unifrac_distance_matrix:
    run: ../../tool/qiime2/diversity.visualizers.beta_group_significance/qiime2-diversity.visualizers.beta_group_significance.cwl
    in:
  ...
  diversity.visualizers.alpha_rarefaction:
    run: ../../tool/qiime2/diversity.visualizers.alpha_rarefaction/qiime2-diversity.visualizers.alpha_rarefaction.cwl
    in:
      table: dada2.methods.denoise_paired/table
      metadata: METADATA
      phylogeny: phylogeny.pipelines.align_to_tree_mafft_fasttree/rooted_tree
  ...
  taxa.visualizers.barplot:
    run: ../../tool/qiime2/taxa.visualizers.barplot/qiime2-taxa.visualizers.barplot.cwl
    in:
      table: dada2.methods.denoise_paired/table
      metadata: METADATA
  ...
  taxa.methods.collapse.table:
    run: ../../tool/qiime2/taxa.methods.collapse/qiime2-taxa.methods.collapse.cwl
    in:
      table: dada2.methods.denoise_paired/table
      taxonomy: feature_classifier.methods.classify_sklearn/classification
      level:
  ...
  feature_table.visualizers.heatmap:
    run: ../../tool/qiime2/feature_table.visualizers.heatmap/qiime2-feature_table.visualizers.heatmap.cwl
    in:
  ...
  feature_table.methods.filter_samples:
    run: ../../tool/qiime2/feature_table.methods.filter_samples/qiime2-feature_table.methods.filter_samples.cwl
    in:
      table: dada2.methods.denoise_paired/table
      metadata: METADATA
      where:
  ...
  composition.methods.add_pseudocount:
    run: ../../tool/qiime2/composition.methods.add_pseudocount/qiime2-composition.methods.add_pseudocount.cwl
    in:
  ...
  composition.visualizers.ancom:
    run: ../../tool/qiime2/composition.visualizers.ancom/qiime2-composition.visualizers.ancom.cwl
    in:
